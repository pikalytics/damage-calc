...
const SV_PATCH: { [name: string]: DeepPartial<SpeciesData> } = {
  ...
  Wigglytuff: {
    types: ['Normal', 'Fairy'],
    bs: {hp: 140, at: 70, df: 45, sa: 85, sd: 50, sp: 45},
    weightkg: 12,
    abilities: {'0': 'Cute Charm'},
  },
  Zubat: {
  ...
  Dewgong: {
    types: ['Water', 'Ice'],
    bs: {hp: 90, at: 70, df: 80, sa: 70, sd: 95, sp: 70},
    weightkg: 120,
    abilities: {'0': 'Thick Fat'},
  },
  Grimer: {
  ...
  'Brute Bonnet': {
    types: ['Grass', 'Dark'],
    bs: {hp: 115, at: 127, df: 99, sa: 79, sd: 99, sp: 55},
    weightkg: 21,
    abilities: {'0': 'Protosynthesis'},
  },
  'Sandy Shocks': {
  ...
  'Ting-Lu': {
    types: ['Dark', 'Ground'],
    bs: {hp: 155, at: 110, df: 130, sa: 50, sd: 80, sp: 45},
    weightkg: 699.7,
...
export const SPECIES = [{}, RBY, GSC, ADV, DPP, BW, XY, SM, SV];
